...
def main() -> int:
    ...
    require_tokens(
        ...
        storage,
        (
            "mount(STORAGE_BLOCK_DEVICE, STORAGE_MOUNT_POINT",
            "STORAGE_FILESYSTEM, 0, nullptr)",
            "mount_error == EBUSY",
