...
def main() -> int:
    ...
    require_tokens(
        ...
        (
            ...
            "run_gnss_reader",
            "gnss_priority_marker",
            'SPRESENSE_M1_GNSS=CREATE\\n',
            'SPRESENSE_M1_GNSS=CREATED\\n',
            'SPRESENSE_M1_GNSS=NAMED\\n',
            'SPRESENSE_M1_GNSS=READY\\n',
            'SPRESENSE_M1_GNSS=SAMPLE\\n',
            'SPRESENSE_M1_GNSS=ATTACH\\n',
            'SPRESENSE_M1_GNSS=READ\\n',
            'SPRESENSE_M1_GNSS=CONSUMED\\n',
            'SPRESENSE_M1_GNSS=THREAD_FAIL\\n',
            "PTHREAD_EXPLICIT_SCHED",
            "SNIOC_SSAMPRATE",
            "GNSS_READER_POLL_TIMEOUT_MS",
            "ready_to_read(gnss_fd, GNSS_READER_POLL_TIMEOUT_MS)",
            "GNSS_READER_YIELD_US",
            "gnss_lock_marker",
            "sched_lockcount()",
