...
EXPECTED = {
    ...
    "rover.wheelbase_mm": 250,
    "rover.wheelbase_status": "user-specified-target",
    ...
    "rover.wheelbase_reference_delta_mm": -2,
    "rover.front_track_mm": None,
    "rover.rear_track_mm": None,
    "rover.track_status": (
        "hardware-HOLD-unmeasured-official-reference-available"
    ),
    "rover.tire_diameter_mm": 90,
    "rover.tire_diameter_status": "user-specified-approximate",
    "rover.tire_width_mm": None,
    "rover.tire_width_status": (
        "hardware-HOLD-unmeasured-official-reference-available"
    ),
...
def main() -> int:
    ...
    require_tokens(
        ...
        (
            ...
            "actual tread is unmeasured",
            "16T / 17.33:1",
            "11.09:1 to 29.28:1",
            "installed gearing is unverified",
            "RS540 / ESC separately required",
            "Tamiya Item 58715",
            "does not silently replace 250 mm with",
            "250 mm",
            "90 mm",
            "50 mm",
            "lock-to-lock",
